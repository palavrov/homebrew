...
class Chrpath < Formula
  desc "Command line tool to adjust the RPATH or RUNPATH of ELF binaries."
  ...
  test do
    ...
    # were more thorough. Run the test with `brew test chrpath`. Options passed
...
+CLEANFILES = *.bb *.bbg *.da *.gcov
 coverage: all check
 	for f in *.c; do gcov $$f; done
diff --git a/Makefile.in b/Makefile.in
index 2fea27c..2dba4a8 100644
--- a/Makefile.in
+++ b/Makefile.in
@@ -278,7 +278,6 @@ target_vendor = @target_vendor@
...
-ac_config_files="$ac_config_files Makefile testsuite/Makefile deb/Makefile"
...
-    "deb/Makefile") CONFIG_FILES="$CONFIG_FILES deb/Makefile" ;;
 
   *) as_fn_error $? "invalid argument: \`$ac_config_target'" "$LINENO" 5;;
   esac
diff --git a/configure.ac b/configure.ac
index 875f0f5..75e3c75 100644
--- a/configure.ac
+++ b/configure.ac
@@ -57,8 +57,6 @@ AC_ARG_WITH(coverage, [Enable coverage testing],
...
diff --git a/deb/Makefile.am b/deb/Makefile.am
deleted file mode 100644
index 530182c..0000000
--- a/deb/Makefile.am
+++ /dev/null
@@ -1 +0,0 @@
-EXTRA_DIST = changelog control copyright dirs docs rules
diff --git a/deb/Makefile.in b/deb/Makefile.in
deleted file mode 100644
index 8ffc69b..0000000
--- a/deb/Makefile.in
+++ /dev/null
@@ -1,359 +0,0 @@
...
-	  esac; \
-	done; \
-	echo ' cd $(top_srcdir) && $(AUTOMAKE) --gnu deb/Makefile'; \
-	$(am__cd) $(top_srcdir) && \
-	  $(AUTOMAKE) --gnu deb/Makefile
-.PRECIOUS: Makefile
...
-usr/bin
-usr/share/doc
diff --git a/deb/docs b/deb/docs
deleted file mode 100644
index 849cde7..0000000
--- a/deb/docs
+++ /dev/null
@@ -1,3 +0,0 @@
-NEWS
...
-	-rm -f *.tab.c
-
-@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/prog.Po@am__quote@
-
-.c.o:
...
-# Otherwise a system limit (for SysV at least) may be exceeded.
-.NOEXPORT:
diff --git a/testsuite/prog.c b/testsuite/prog.c
deleted file mode 100644
